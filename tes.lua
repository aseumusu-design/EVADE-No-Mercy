...
do
    ...
    local BLUE_TEXT = Color3.fromRGB(166, 211, 247)
    local BLUE_TITLE = Color3.fromRGB(126, 196, 255)
    ...
    -- satu loop global: kilau menyapu lalu hilang, ulang terus
    task.spawn(function()
        local SWEEP = 1.2
        local REST = 1.6
        local info = TweenInfo.new(SWEEP, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut)
